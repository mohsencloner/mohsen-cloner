local function run(msg, matches)
	if #matches < 2 then
		return "بعد از این دستور، با قید یک فاصله کلمه یا جمله ی مورد نظر را جهت زیبا نویسی وارد کنید 😐❤️"
	end
	if string.len(matches[2]) > 20 then
		return "حداکثر حروف مجاز 20 کاراکتر انگلیسی و عدد است 😐❤️"
	end
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	local result_text = "انجام شد !\n\nکلمه ی اولیه: "..matches[2].." 👌\n\nطراحی با "..tostring(#fonts).." فونت 👇\n______________________________\n"
	a=0
	for v=1,#result do
		a=a+1
