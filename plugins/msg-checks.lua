...
del_msg(msg.chat_id_, tonumber(msg.id_))
  ...
  tdcli.pinChannelMessage(msg.chat_id_, pin_msg, 1)
   ...
   tdcli.unpinChannelMessage(msg.chat_id_)
    ...
    if lang then
	tdcli.sendMessage(msg.chat_id_, msg.id, 0, '<i>You Have Not Permission To Pin Message, Last Message Has Been Pinned Again</i>', 0, "html")     
	elseif not lang then
	tdcli.sendMessage(msg.chat_id_, msg.id, 0, '<b>کاربر گرامی سنجاق کردن پیام در گروه قفل است ! </b>\n<b> و شما اجازه سنجاق کردن پیام را ندارید ... 😐❤️</b>', 0, "html")
...
return
   ...
   del_msg(msg.chat_id_, msg.id_)
    kick_user(user, chat)
  tdcli.sendMessage(msg.chat_id_, msg.id_, 0, "*کاربر* `[ "..user.." ]` *به دلیل ارسال پیام مکرر اخراج شد 😐❤️*", 0, "md")
